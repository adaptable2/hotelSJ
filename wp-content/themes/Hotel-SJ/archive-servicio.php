...
<div class="servicios pb-5">
	<section class="banner-interna container-fluid d-flex justify-content-center align-items-center font-arabic font-upper" style="background: url(<?php echo get_template_directory_uri(); ?>/img/bn-servicios.jpg) no-repeat center center / cover;">
		<h1>Servicios</h1>
	</section>
